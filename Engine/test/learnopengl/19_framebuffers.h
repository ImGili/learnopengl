...
namespace glx0192
{
    ...
    int main()
    {
        ...
        // -------------------------
        Shader shader("./15/l1/ObjectVertex.vert", "./15/l1/ObjectFragment.frag");
        Shader screenShader("./19/l2/ObjectVertex.vert", "./19/l2/ObjectFragment.frag");
...
namespace glx0193
{
    ...
    int main()
    {
        ...
        // -------------------------
        Shader shader("./15/l1/ObjectVertex.vert", "./15/l1/ObjectFragment.frag");
        Shader screenShader("./19/l3/ObjectVertex.vert", "./19/l3/ObjectFragment.frag");
...
namespace glx0194
{
    ...
    int main()
    {
        ...
        // -------------------------
        Shader shader("./15/l1/ObjectVertex.vert", "./15/l1/ObjectFragment.frag");
        Shader screenShader("./19/l4/ObjectVertex.vert", "./19/l4/ObjectFragment.frag");

    ...
    int main()
    {
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
            {
                ...
                const char *items[] = {"GL_ALWAYS", "GL_NEVER", "GL_LESS", "GL_EQUAL", "GL_LEQUAL", "GL_GREATER", "GL_NOTEQUAL", "GL_GEQUAL"};
                ImGui::Combo("深度测试函数", &item_current, items, IM_ARRAYSIZE(items));

...
namespace glx0161
{
    ...
    int main()
    {
        ...
        // -------------------------
        Shader shader(GET_SHADER_PATH("/16/l1/ObjectVertex.vert"), GET_SHADER_PATH("/16/l1/ObjectFragment.frag"));
        Shader singleShader(GET_SHADER_PATH("/16/l1/ObjectVertex.vert"), GET_SHADER_PATH("/16/l1/SingleColor.frag"));
